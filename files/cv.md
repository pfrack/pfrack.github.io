...
headline: Software Architect / Kubstronaut
knowsAbout:
  - Core Languages
  - Golang
  - Python
...
hasCredential:
  ...
  - CKA (CNCF, Dec 2024)
  - KCNA (CNCF, Aug 2025)
  - Kubstronaut (CNCF, Aug 2025)
  - Google Cloud Professional Cloud Architect (Google Cloud, Dec 2023)
  - Capgemini Certified Architect (Capgemini, Feb 2022)
  - UiPath RPA Developer Advanced (UiPath, Nov 2019)
  - ISTQB Advanced Level Technical Test Analyst (ISTQB, Oct 2014)
  - ITIL Foundation (AXELOS, Oct 2021)
locale: en_US
---
...
### Architect (Go, Python, GenAI) / Lead Developer *(Managing Solution Architect)*

*Capgemini Polska Sp. z o.o., Wrocław, Mar 2022 -- Present*
...
- **Enterprise Security Integration:** Contributed to development of a Go-based Key Management System (KMS) for SAP BTP. Implemented critical gRPC/OAuth2 components to enable secure cryptographic operations in a cloud-native environment.
- **Project Leadership & Mentoring:** Led dynamic project-based engineering teams across Go/Python streams. Managed recruitment processes and guided strategic migration from legacy RPA to modern Power Platform architectures.
...
### Architect (Go, RPA) / Lead Developer *(Senior App. Consultant)*

*Capgemini Polska Sp. z o.o., Wrocław, Jan 2020 -- Mar 2022*
...
### Lead Automation Engineer *(Senior Test Consultant)*

*Capgemini Polska Sp. z o.o., Wrocław, Jan 2019 -- Jun 2020*
...
### Technical Trainer (Python & Selenium)

*Testuj.pl, Wrocław, Dec 2018 -- Apr 2019*
...
### Lead Automation Engineer (Embedded Web) *(Senior Test Engineer)*

*Silicon & Software Systems Polska Sp. z o.o., Wrocław, Dec 2015 -- Dec 2018*
...
*Fara Polska Sp. z o.o., Warsaw, Nov 2013 -- Nov 2015*

### R&D Specialist / Test Engineer

*Telekomunikacja Polska S.A. (Orange Labs), Jun 2009 -- Oct 2013*
...
### Postgraduate Studies in E-Business

*Warsaw University of Technology, Poland, 2010*

- Focus: E-business strategies, internet technologies, and digital commerce models.

### M.Sc. Eng. in Electronics and Telecommunications

*Poznań University of Technology, Poland, 2008*
...
- **Kubernetes Ecosystem (Kubstronaut):** CKS (Oct 2025), KCSA (Nov 2025), CKAD (Jul 2025), CKA (Dec 2024), KCNA (Aug 2025). Awarded the **Kubstronaut** title for holding all 5 CNCF certifications simultaneously

- **Cloud & Architecture:** Google Cloud Professional Cloud Architect (Dec 2023), Capgemini Certified Architect (Feb 2022).

- **Other:** UiPath RPA Developer Advanced (Nov 2019), ISTQB Advanced Level Technical Test Analyst (Oct 2014), ITIL Foundation (Oct 2021).
